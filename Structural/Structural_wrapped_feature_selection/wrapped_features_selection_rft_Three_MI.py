...
for it in ['Three']:
    ...
    features.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/features_kept_%s.csv"%(it,it))
    ...
    print(r_dtf)
    r_dtf.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/r_dtf_%s.p"%(it, it))
    ...
    for m in num_feats_keep:
        ...
        inc_m += 1   
    pd.DataFrame(stability).to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/stability_%s.csv"%(it, it))
    ...
    df.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/accuracy_%s.csv"%(it, it))

    weights_dtf.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/weigts_%s.csv"%(it, it))
    weights_dtf.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/weigts_%s.p"%(it, it))
    ...
    final_importance_001.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/final_importance_005_%s.csv"%(it, it))
    final_importance_001.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/final_importance_005_%s.p"%(it, it))
    final_importance_002.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/final_importance_01_%s.csv"%(it, it))
    final_importance_002.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/final_importance_01_%s.p"%(it, it))
    final_importance_003.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/final_importance_025_%s.csv"%(it, it))
    final_importance_003.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/final_importance_025_%s.p"%(it, it))
    final_importance_004.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/final_importance_05_%s.csv"%(it, it))
    final_importance_004.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/final_importance_05_%s.p"%(it, it))
    ...
    mean_per_num_feat_kept.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/struct/rft/mean_accuracy_%s.csv"%(it, it))
