...
for it in ['Three']:
    regions_kept = pd.read_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/feature_selection2/regions_selected_corr_struct_%s.p"%it)#pd.read_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/feature_selection2/regions_selected_corr_1.csv")
    features = features[regions_kept[0]].abs()
    features.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/features_kept_%s.csv"%(it,it))
    ...
    features.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/features_kept_redundant_%s.csv"%(it,it))
    ...
    print(r_dtf)
    r_dtf.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/r_dtf_%s.p"%(it, it))
    ...
    for m in num_feats_keep:
        ...
        inc_m += 1   
    pd.DataFrame(stability).to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/stability_%s.csv"%(it, it))
    ...
    df.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/accuracy_%s.csv"%(it, it))

    weights_dtf_H_VCNC .to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/weigts_H_VCNC _%s.csv"%(it, it))
    weights_dtf_H_VCNC .to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/weigts_H_VCNC _%s.p"%(it, it))
    weights_dtf_HVC_VNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/weigts_HVC_VNC_%s.csv"%(it, it))
    weights_dtf_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/weigts_HVC_VNC_%s.p"%(it, it))

    weights_ordered_H_VCNC = get_weights_ordered(weights_dtf_H_VCNC, "Weights_H_VCNC", param)
    weights_ordered_H_VCNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/weights_ordered_%s.csv"%(it, it))
    ...
    final_importance_045_H_VCNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_005_H_VCNC_%s.csv"%(it, it))
    final_importance_045_H_VCNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_005_H_VCNC_%s.p"%(it, it))
    final_importance_055_H_VCNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_01_H_VCNC_%s.csv"%(it, it))
    final_importance_055_H_VCNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_01_H_VCNC_%s.p"%(it, it))
    final_importance_065_H_VCNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_025_H_VCNC_%s.csv"%(it, it))
    final_importance_065_H_VCNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_025_H_VCNC_%s.p"%(it, it))
    final_importance_075_H_VCNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_05_H_VCNC_%s.csv"%(it, it))
    final_importance_075_H_VCNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_05_H_VCNC_%s.p"%(it, it))
   
    weights_ordered_HVC_VNC = get_weights_ordered(weights_dtf_HVC_VNC, "Weights_HVC_VNC", param)
    weights_ordered_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/weights_ordered_HVC_VNC_%s.p"%(it, it))
    ...
    final_importance_045_HVC_VNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_005_HVC_VNC_%s.csv"%(it, it))
    final_importance_045_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_005_HVC_VNC_%s.p"%(it, it))
    final_importance_055_HVC_VNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_01_HVC_VNC_%s.csv"%(it, it))
    final_importance_055_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_01_HVC_VNC_%s.p"%(it, it))
    final_importance_065_HVC_VNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_025_HVC_VNC_%s.csv"%(it, it))
    final_importance_065_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_025_HVC_VNC_%s.p"%(it, it))
    final_importance_075_HVC_VNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_05_HVC_VNC_%s.csv"%(it, it))
    final_importance_075_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/final_importance_05_HVC_VNC_%s.p"%(it, it))
    ...
    mean_per_num_feat_kept.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/struct/svc/mean_accuracy_%s.csv"%(it, it))
