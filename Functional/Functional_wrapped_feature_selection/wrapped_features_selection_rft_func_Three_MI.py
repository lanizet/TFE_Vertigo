...
for it in ['Three']:
    ...
    features.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/features_kept_func_%s.csv"%(it,it))
    ...
    print(r_dtf)
    r_dtf.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/r_dtf4_%s.p"%(it, it))
    ...
    for m in num_feats_keep:
        ...
        inc_m += 1   
    pd.DataFrame(stability).to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/stability4_%s.csv"%(it, it))
    ...
    df.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/accuracy4_%s.csv"%(it, it))

    weights_dtf.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/weigts4_%s.csv"%(it, it))
    weights_dtf.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/weigts4_%s.p"%(it, it))

    weights_ordered = get_weights_ordered(weights_dtf, param)

    weights_ordered.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/weights_ordered4_%s.csv"%(it, it))
    weights_ordered.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/weights_ordered4_%s.p"%(it, it))
    ...
    final_importance_001.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/final_importance4_002_%s.csv"%(it, it))
    final_importance_001.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/final_importance4_002_%s.p"%(it, it))
    final_importance_002.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/final_importance4_004_%s.csv"%(it, it))
    final_importance_002.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/final_importance4_004_%s.p"%(it, it))
    final_importance_003.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/final_importance4_006_%s.csv"%(it, it))
    final_importance_003.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/final_importance4_006_%s.p"%(it, it))
    final_importance_004.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/final_importance4_008_%s.csv"%(it, it))
    final_importance_004.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/final_importance4_008_%s.p"%(it, it))
    ...
    mean_per_num_feat_kept.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection_MI/%s/func/rft/mean_accuracy4_%s.csv"%(it, it))
