...
for it in ['Three']:
    ...
    features.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/features_kept_%s.csv"%(it,it))
    ...
    features.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/features_kept_redundant_%s.csv"%(it,it))
    print(len(features.index))
    
    #Percentage of features selected
    num_feats_keep = (np.array([0.20, 0.30, 0.35, 0.45])*features.shape[1]).astype(int)
    ...
    print(r_dtf)
    r_dtf.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/r_dtf_%s.p"%(it, it))
    ...
    for m in num_feats_keep:
        ...
        inc_m += 1   
    pd.DataFrame(stability).to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/stability_%s.csv"%(it, it))
    ...
    df.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/accuracy_%s.csv"%(it, it))

    weights_dtf_H_VCNC .to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/weigts_H_VCNC _%s.csv"%(it, it))
    weights_dtf_H_VCNC .to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/weigts_H_VCNC _%s.p"%(it, it))
    weights_dtf_HVC_VNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/weigts_HVC_VNC_%s.csv"%(it, it))
    weights_dtf_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/weigts_HVC_VNC_%s.p"%(it, it))
    ...
    weights_ordered_H_VCNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/weights_ordered_%s.csv"%(it, it))
    ...
    final_importance_045_H_VCNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_02_H_VCNC_%s.csv"%(it, it))
    final_importance_045_H_VCNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_02_H_VCNC_%s.p"%(it, it))
    final_importance_055_H_VCNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_03_H_VCNC_%s.csv"%(it, it))
    final_importance_055_H_VCNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_03_H_VCNC_%s.p"%(it, it))
    final_importance_065_H_VCNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_035_H_VCNC_%s.csv"%(it, it))
    final_importance_065_H_VCNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_035_H_VCNC_%s.p"%(it, it))
    final_importance_075_H_VCNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_045_H_VCNC_%s.csv"%(it, it))
    final_importance_075_H_VCNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_045_H_VCNC_%s.p"%(it, it))
    ...
    weights_ordered_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/weights_ordered_HVC_VNC_%s.p"%(it, it))
    ...
    final_importance_045_HVC_VNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_02_HVC_VNC_%s.csv"%(it, it))
    final_importance_045_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_02_HVC_VNC_%s.p"%(it, it))
    final_importance_055_HVC_VNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_03_HVC_VNC_%s.csv"%(it, it))
    final_importance_055_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_03_HVC_VNC_%s.p"%(it, it))
    final_importance_065_HVC_VNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_035_HVC_VNC_%s.csv"%(it, it))
    final_importance_065_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_035_HVC_VNC_%s.p"%(it, it))
    final_importance_075_HVC_VNC.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_045_HVC_VNC_%s.csv"%(it, it))
    final_importance_075_HVC_VNC.to_pickle("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/final_importance_045_HVC_VNC_%s.p"%(it, it))
    ...
    mean_per_num_feat_kept.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/wrapped_features_selection/%s/func/svc/mean_accuracy_%s.csv"%(it, it))
