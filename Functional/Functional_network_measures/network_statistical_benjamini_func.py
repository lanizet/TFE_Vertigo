...
#-----------------------------------------------------------------------
degree_left = pd.read_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/functional_network_measures/stats_degree_left.csv")
degree_left = degree_left.drop("Unnamed: 0", axis=1)
degree_left = degree_left.sort_values(by = ['p-value'], axis=0)

between_left = pd.read_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/functional_network_measures/stats_between_left.csv")
between_left = between_left.drop("Unnamed: 0", axis=1)
between_left = between_left.sort_values(by = ['p-value'], axis=0)

degree_right = pd.read_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/functional_network_measures/stats_degree_right.csv")
degree_right = degree_right.drop("Unnamed: 0", axis=1)
degree_right = degree_right.sort_values(by = ['p-value'], axis=0)

between_right = pd.read_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/functional_network_measures/stats_between_right.csv")
...
#-----------------------------------------------------------------------
degree_left.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/functional_network_measures/stats_degree_left_benjamini_func.csv")
between_left.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/functional_network_measures/stats_between_left_benjamini_func.csv")
degree_right.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/functional_network_measures/stats_degree_right_benjamini_func.csv")
between_right.to_csv("/CECI/proj/pilab/PermeableAccess/vertige_LEWuQhzYs9/functional_network_measures/stats_between_right_benjamini_func.csv")
